...
---@field with fun(self: Class, ...): Class
---@field includes fun(self: Class, mixin: table): boolean
---@field without fun(self: Class, ...): Class
---@field subclassOf fun(self: Class, superclass: Class): boolean
---@field classOf fun(self: Class, subclass: Class): boolean
---@field instances fun(self: Class, filter?: function, ...): Instance[]
---@field subclasses fun(self: Class, filter?: function, ...): Class[]
